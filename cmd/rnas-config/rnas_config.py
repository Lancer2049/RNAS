...
def main():
    ...
    gen.add_argument("service", choices=["accel-ppp", "dnsmasq", "firewall", "snmp", "qos", "ipsec", "wireguard", "openvpn", "hotspot", "ha", "dhcp-relay", "dot1x"], help="Service to generate config for")
